...
from core.attack_classifier import get_classifier
from core.shap_explainer import get_explainer
...
BASE_DIR = Path(__file__).resolve().parent.parent / "models"  # → MLOPS/models/
